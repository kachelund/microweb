...
<div>
    ...
    <div class="custom-control custom-switch my-3">
        <input id="show_logged_in" name="show_logged_in" type="checkbox" class="custom-control-input" <?= settings()->announcements->show_logged_in ? 'checked' : null?>>
        <label class="custom-control-label" for="show_logged_in"><?= language()->admin_settings->announcements->show_logged_in ?></label>
    </div>

    <div class="custom-control custom-switch my-3">
        <input id="show_logged_out" name="show_logged_out" type="checkbox" class="custom-control-input" <?= settings()->announcements->show_logged_out ? 'checked' : null?>>
